...
class BooksPublicOperations 
{
    ...
    public:
        ...
        {
            pointers.printBooks(B_borrowed);
        }

        //! to chose who is the user , caller is:  customer  or employee
        void browsePurchasedBooks(const string &caller)
        {
            pointers.printBooks(B_purchased);
        }
...
class EmployeeOperations : public BooksPublicOperations 
{
    public:
        void AddBooks()
        {
            ...
            pointers.addBookInList(B, newBook);
        ...
        void DeleteBooks()
        {
            ...
            if (pointers.removeByCode(B, code)) {
        ...
        void UpdateBooks()
        {
            ...
            Books* bookToUpdate = pointers.findByCode(B, code);
    ...
    public:
        ...
        void employeeMenuChoice()
        {
            ...
            do
            {
                ...
                {
                    case 1: //! Browse Books
                        employeeOp.browseBooksMenuChoice("employee");
                        break;
