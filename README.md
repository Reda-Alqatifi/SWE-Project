...
void ManagerOperations::deleteEmployee(Employee* emp)
{
    if (emp == nullptr)
    {
        cout << "\n> Employee pointer is invalid.\n";
        return;
    }
    ...
    char confirm;
    cout << "\n> Are you sure you want to delete employee " << target->get_name() << "? (Y/N): ";
    cin >> confirm;
...
void ManagerOperations::editSalary()
{
    string email;
...
void ManagerOperations::changeKey_Code()
{
    int newMngCode;
    cout << "\n> Enter the new Manager Key_Code: ";
    cin >> newMngCode;
    MNG_key_code = newMngCode;
    cout << "\n> Manager Key_Code updated successfully.\n";
}

void ManagerOperations::viewEmployeesData()
{
    cout << "\n> Employees List:\n";
    pointers.printUsers(employees);
}

void ManagerOperations::browseFinancialReports()
{
    cout << "\n> Financial Reports are not implemented yet.\n";
}
